...
model_names = {
    "lorem": r"\textsc{Lorem}, Original",
    "lorem-tuned-energy": r"\textsc{Lorem}, Tuned E",
    "lorem-tuned-forces": r"\textsc{Lorem}, Tuned F",
}


model_colors = {
    "lorem": red,
    "lorem-tuned-energy": teal,
    "lorem-tuned-forces": orange,
}


model_linestyles = {
    "lorem": solid,
    "lorem-tuned-energy": dotted,
    "lorem-tuned-forces": dashed,
}
...
savefig(fig, "figures/aumgo_supp_lorem_hp")
