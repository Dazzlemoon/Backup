...
save_folder = "/data/home/public/qiuqizhi/SOG-Qeq/SOG-Net/CACE-LOREM/fit-cumulene2/loss_data/CACE_LOREM_MP"+str(MP)+"_ABtest4_strict"
...
if args.sr_freeze_experiment:
    ...
    #   3-5) progressive SR return (0.1 -> 0.3 -> 0.5)
    total_epochs = max(1, int(args.max_epochs))
    stage1_epochs = max(1, int(round(total_epochs * 0.15)))
    stage2_epochs = max(1, int(round(total_epochs * 0.45)))
    stage3_epochs = max(1, int(round(total_epochs * 0.15)))
    stage4_epochs = max(1, int(round(total_epochs * 0.15)))
    stage5_epochs = total_epochs - stage1_epochs - stage2_epochs - stage3_epochs - stage4_epochs
    if stage5_epochs < 1:
        deficit = 1 - stage5_epochs
        stage5_epochs = 1
    ...
    if args.quick_test:
        ...
        print(f"[Strict5Phase] phase_plan={phase_plan}")
