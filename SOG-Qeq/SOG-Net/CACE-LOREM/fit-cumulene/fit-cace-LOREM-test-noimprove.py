...
save_folder = "/data/home/public/qiuqizhi/SOG-Qeq/SOG-Net/CACE-LOREM/fit-cumulene/loss_data/CACE_LOREM_MP"+str(MP)+"_test_noimprove"
DEFAULT_MAX_EPOCHS = 500
DEFAULT_START_LR = 1e-3
DEFAULT_MIN_LR = 1e-6
DEFAULT_START_DECAY_AFTER = 10
DEFAULT_LR_WEIGHT = 1.0
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="LR branch weight for default long training mode (baseline=1.0; set >1 to enable enhancement).",
    )
    parser.add_argument(
...
if args.sr_freeze_experiment:
    ...
    # without LR enhancement by default (lr_weight=1.0).
    # You can still enable enhancement manually via --default-lr-weight > 1.
    stage_plan = [
